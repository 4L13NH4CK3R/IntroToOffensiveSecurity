...
Please visit the link http://MACHINE_IP/  
...
*Give Lab #1 a try and read /etc/passwd. What would be the request URI be?* **lab1.php?file=/etc/passwd/**  
...
*Give Lab #3 a try to read /etc/passwd. What is the request look like?* **/lab3.php?file=../../../../etc/passwd**  
*Which function is causing the directory to traversal in Lab #4?* **file_get_contents**  
...
Visit the following lab URL: http://10.10.130.37/playground.php to try out an RFI attack.  
...
Make sure the attached VM is up and running then visit: http://10.10.130.37/challenges/index.php
